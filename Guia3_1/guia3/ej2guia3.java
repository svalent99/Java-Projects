...
public class ej2guia3 {
    ...
    public static void main(String[] args) {
      ...
      //Si el tipo de motor es 3, mostrar un mensaje indicando “La bomba es una bomba de hormigón”.
        //Si el tipo de motor es 4, mostrar un mensaje indicando Si el tipo de motor es 3, mostrar un mensaje indicando “La bomba es una bomba de hormigón”..
       //Si no se cumple ninguno de los valores anteriores mostrar el mensaje “No existe un valor válido para tipo de bomba”
       
        Scanner leer = new Scanner(System.in);
        
        System.out.println("ingrese su tipo de bomba ");
